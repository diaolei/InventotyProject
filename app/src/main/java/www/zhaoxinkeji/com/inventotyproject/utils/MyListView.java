...
public class MyListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private LinearLayout mFootLoadLl;
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.head_in, null);
        pb_rotate = (ProgressBar) headerView.findViewById(R.id.progressbar);
        tv_state = (TextView) headerView.findViewById(R.id.update_info);
        tv_time = (TextView) headerView.findViewById(R.id.update_time);
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.proces_layout, null);
        mFootLoadLl = (LinearLayout) footerView.findViewById(R.id.foot_load);
        mBottomTv = (TextView) footerView.findViewById(R.id.bottom_tv);
    ...
    public void complete(){
        if(isLoadingMore){
            //重置footerView状态
            mFootLoadLl.setVisibility(View.GONE);
