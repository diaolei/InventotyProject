package www.zhaoxinkeji.com.inventotyproject.module.purchase_out_goods.adapter;
...
public class PurchaseOutGoodsAdapter extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    public List<String> mList;

    public PurchaseOutGoodsAdapter(Context context, List<String> list){
        mContext=context;
