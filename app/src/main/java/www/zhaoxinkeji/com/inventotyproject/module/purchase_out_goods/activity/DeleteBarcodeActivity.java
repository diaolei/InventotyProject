...
import www.zhaoxinkeji.com.inventotyproject.module.purchase_out_goods.contract.PurchaseOutGoodsContract;
import www.zhaoxinkeji.com.inventotyproject.module.purchase_out_goods.presenter.PurchaseOutGoodsPresenter;
 ...
 * </pre>
 */
public class DeleteBarcodeActivity extends BaseActivity<PurchaseOutGoodsPresenter> implements PurchaseOutGoodsContract.View {
    ...
    @Override
    public PurchaseOutGoodsPresenter initPresenter() {
        return new PurchaseOutGoodsPresenter(this);
    }
